...
class ViewPagerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val layout = R.layout.motion_viewpager
        setContentView(layout)


        val adapter = ViewPagerAdapter(supportFragmentManager)

        adapter.addPage("Page 1", R.layout.motion_viewpager_page1)
        adapter.addPage("Page 2", R.layout.motion_viewpager_page2)
        adapter.addPage("Page 3", R.layout.motion_viewpager_page3)
